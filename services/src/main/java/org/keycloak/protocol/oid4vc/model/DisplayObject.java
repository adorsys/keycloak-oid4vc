...
public class DisplayObject {
    ...
    // Backward compatibility method for string logo
    @JsonIgnore
    public String getLogoUri() {
        return logo != null ? logo.getUri() : null;
    }

    @JsonIgnore
    public DisplayObject setLogoUri(String logoUri) {
        if (logoUri != null) {
            this.logo = new LogoObject().setUri(logoUri);
        }
        return this;
    }
