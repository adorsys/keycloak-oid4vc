...
public class CredentialBuildConfig {
    ...
    public Map<String, String> toDotNotation() {
        ...
        Optional.ofNullable(tokenJwsType)
                .ifPresent(format -> dotNotation.put(prefix + TOKEN_JWS_TYPE_KEY, tokenJwsType));
        Optional.ofNullable(hashAlgorithm)
                .ifPresent(format -> dotNotation.put(prefix + HASH_ALGORITHM_KEY, hashAlgorithm));
    ...
    public boolean equals(Object o) {
        ...
        return numberOfDecoys == that.numberOfDecoys && Objects.equals(credentialType, that.credentialType) && Objects.equals(tokenJwsType, that.tokenJwsType) && Objects.equals(hashAlgorithm, that.hashAlgorithm) && Objects.equals(visibleClaims, that.visibleClaims) && Objects.equals(credentialId, that.credentialId);
    }
